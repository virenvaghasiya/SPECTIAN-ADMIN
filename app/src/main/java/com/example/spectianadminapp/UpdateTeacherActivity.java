...
public class UpdateTeacherActivity extends AppCompatActivity {
        ...
        reference.child(category).child(uniqueKey).removeValue()
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        Toast.makeText(com.example.spectianadminapp.UpdateTeacherActivity.this, "Teacher deleted successfully", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(com.example.spectianadminapp.UpdateTeacherActivity.this, UpdateFaculty.class);
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(com.example.spectianadminapp.UpdateTeacherActivity.this, "Something went wrong", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void updateData(String s) {
        ...
        reference.child(category).child(uniqueKey).updateChildren(hp).addOnSuccessListener(new OnSuccessListener() {
            ...
            public void onSuccess(Object o) {
                Toast.makeText(com.example.spectianadminapp.UpdateTeacherActivity.this, "Teacher updated successfully", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(com.example.spectianadminapp.UpdateTeacherActivity.this, UpdateFaculty.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
            }
    ...
    private void uploadImage() {
        ...
        uploadTask.addOnCompleteListener(com.example.spectianadminapp.UpdateTeacherActivity.this, new OnCompleteListener<UploadTask.TaskSnapshot>() {
            @Override
